...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictOptions={}):
        ...
        kwds['label'] = "Valider"
        kwds['name'] = "btnOk"
        kwds['onBtn'] = self.OnBoutonOk
        kwds['image'] = VALIDER_32X32_IMG
        kwds['sizeBmp'] = (32,32)
        kwds['sizeFont'] = 12

        self.bouton_ok = xboutons.Bouton(self, **kwds)
        kwds['label'] = "Annuler"
        kwds['name'] = "btnOk"
        kwds['onBtn'] = self.OnBoutonAnnuler
        kwds['image'] = ANNULER_32X32_IMG
        self.bouton_annuler = xboutons.Bouton(self,**kwds)
