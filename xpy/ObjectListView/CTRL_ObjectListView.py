...
class ObjectListView(OLV.ObjectListView):
    ...
    def AjouterCommandesMenuContext(self, menu=None):
        ...
        item.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/Mecanisme.png", wx.BITMAP_TYPE_PNG))
        menu.Append(item)
...
##        self.modelObjects.append(track)
    ...
    def GenerationContextMenu(self, menu=None, intro="", total="", titre=None, orientation=wx.PORTRAIT, dictParametres=None):
        ...
        if self.checkStateColumn != None:
            ...
            item.SetBitmap(wx.Bitmap(
                "xpy/Images/16x16/Cocher.png", wx.BITMAP_TYPE_PNG))
            menu.Append(item)
            ...
            item.SetBitmap(wx.Bitmap(
                "xpy/Images/16x16/Decocher.png", wx.BITMAP_TYPE_PNG))
            menu.Append(item)
        ...
        item.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/Apercu.png", wx.BITMAP_TYPE_PNG))
        menu.Append(item)
        ...
        item.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/Imprimante.png", wx.BITMAP_TYPE_PNG))
        menu.Append(item)
        ...
        item.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/Texte2.png", wx.BITMAP_TYPE_PNG))
        menu.Append(item)
        ...
        item.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/Excel.png", wx.BITMAP_TYPE_PNG))
        menu.Append(item)
        ...
        if len(self.GetObjects()) > 0 :
            ...
            if famille == True or individu == True :
                ...
                item.SetBitmap(wx.Bitmap(
                    "xpy/Images/16x16/Editeur_email.png", wx.BITMAP_TYPE_PNG))
                menu.Append(item)
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent, listview, texteDefaut=u"Rechercher..."):
        ...
        self.SetCancelBitmap(wx.Bitmap(
            "xpy/Images/16x16/Interdit.png",
            wx.BITMAP_TYPE_PNG))
        self.SetSearchBitmap(wx.Bitmap(
            "xpy/Images/16x16/Loupe.png",
            wx.BITMAP_TYPE_PNG))
...
class CTRL_Outils(wx.Panel):
    def __init__(self, parent, listview=None, texteDefaut=u"Rechercher...",
        ...
        item.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/Filtre_supprimer.png",
            wx.BITMAP_TYPE_ANY))
        menu.Append(item)
    ...
    def MAJ_ctrl_filtrer(self):
        ...
        self.bouton_filtrer.SetBitmap(wx.Bitmap(
            "xpy/Images/16x16/%s.png" % nomImage,
            wx.BITMAP_TYPE_ANY))
