...
class Calendrier(wx.ScrolledWindow):
    ...
    def OnMotion(self, event):
        ...
        if len(listeObjets) != 0:
            ...
            listeMois = (
            (u"janvier"), (u"février"), (u"mars"), (u"avril"), (u"mai"), (u"juin"), (u"juillet"), (u"août"),
    ...
    def OnContextMenu(self, nomCase):
        ...
        if self.multiSelections == True:
            ...
            menu.Append(self.popupID6, (u"Exclure les week-ends des sélections"),
                        (u"Exclure les week-ends de la sélection"), wx.ITEM_CHECK)
